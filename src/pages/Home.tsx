...
const Home: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Detaylı raporlar ve grafiklerle öğrenci performansını analiz edin."
    },
    {
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-left">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
              ...
              <p className="text-blue-100">Otomatik değerlendirme ve raporlama ile saatlerce zaman kazanın.</p>
            </div>
