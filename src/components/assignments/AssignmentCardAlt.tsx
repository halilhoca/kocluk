                  ...
                  {assignment.note && (
                    <div className="bg-gradient-to-r from-blue-100 to-blue-50 border-l-4 border-blue-500 p-3 rounded-r-lg shadow-sm">
                      <div className="flex items-center justify-between">
                        <span className="text-base font-semibold text-blue-800 leading-relaxed block flex-1">
                          {assignment.note}
                        </span>
                        {isStudent && (
                           <button
                             onClick={handleToggle}
                             className={`ml-3 px-4 py-2 rounded-lg text-sm font-bold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 ${
